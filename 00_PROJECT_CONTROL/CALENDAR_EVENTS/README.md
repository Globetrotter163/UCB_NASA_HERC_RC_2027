...
- `status`: `planned`, `confirmed`, `completed`, `cancelled` o `example`

## Reglas

- El calendario no aprueba decisiones ni pruebas.
- Enlace el documento técnico relacionado.
- No copie URLs ICS privadas, tokens o datos sensibles.
